...
void BaseVehicleDisplayPresenter::connectNode(domain::Telemetry* node)
{
    ...
    this->chainNode(ahrs, std::bind(&BaseVehicleDisplayPresenter::updateAhrs, this, std::placeholders::_1));
    this->chainNode(ahrs->childNode(domain::Telemetry::Compass),
                    std::bind(&BaseVehicleDisplayPresenter::updateCompass, this, std::placeholders::_1));

    this->chainNode(node->childNode(domain::Telemetry::Satellite),
                    std::bind(&BaseVehicleDisplayPresenter::updateSatellite, this, std::placeholders::_1));
    this->chainNode(node->childNode(domain::Telemetry::PowerSystem),
                    std::bind(&BaseVehicleDisplayPresenter::updatePowerSystem, this, std::placeholders::_1));
    this->chainNode(node->childNode(domain::Telemetry::Battery),
                    std::bind(&BaseVehicleDisplayPresenter::updateBattery, this, std::placeholders::_1));
    this->chainNode(node->childNode(domain::Telemetry::HomePosition),
                    std::bind(&BaseVehicleDisplayPresenter::updateHome, this, std::placeholders::_1));
    this->chainNode(node->childNode(domain::Telemetry::Position),
                    std::bind(&BaseVehicleDisplayPresenter::updatePosition, this, std::placeholders::_1));
}
