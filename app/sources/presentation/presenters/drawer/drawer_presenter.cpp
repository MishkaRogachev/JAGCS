...
namespace
{
    const QMultiMap<DrawerPresenter::Mode, DrawerPresenter::Mode> nestedModes
    {
        ...
        { DrawerPresenter::Home, DrawerPresenter::Links },
        { DrawerPresenter::Home, DrawerPresenter::Plugins },
    ...
    const QMap<DrawerPresenter::Mode, QUrl> modeIcons
    {
        ...
        { DrawerPresenter::Links, QUrl("qrc:/icons/connect.svg") },
        { DrawerPresenter::Plugins, QUrl("qrc:/icons/plugins.svg") },
...
QString DrawerPresenter::modeString(Mode mode) const
{
    static const QMap<DrawerPresenter::Mode, QString> modeStrings
    {
        ...
        { DrawerPresenter::Links, tr("Links") },
        { DrawerPresenter::Plugins, tr("Plugins") },
